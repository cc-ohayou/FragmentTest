...
public class NotificationUtil {
    ...
    public static void gotoOpenNotificationActivity(Context  context, final Activity activity){
       ...
       if(!isNotificationEnabled(context)){
           ...
           UtilBox.box().dialog.showMaterialDialogSimleDefault(activity, "Notification Settings",
                   "前往应用通知设置", new MaterialDialog.SingleButtonCallback() {
               @Override
...
//                       应用通知权限不开启，可能会导致通知提醒服务异常，确定不设置吗？
                       ToastUtils.showLong("应用通知权限未开启，可能会导致通知提醒服务异常，" +
